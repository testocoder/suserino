/* Undercover – Spiellogik (Pass-and-Play, Zustandsmaschine).
...
const STATE_KEY = "undercover.state";
const MAX_ANSWER = 40;
...
const CUSTOM_CONFIG = {
  storageKey: "undercover.customCategories",
  itemNoun: "Fragenpaar",
  minEntries: 5,
  fields: [
  ...
  aiPrompt: `Erstelle mir 30 Fragenpaare für das Partyspiel „Undercover“ zum Thema [THEMA].
